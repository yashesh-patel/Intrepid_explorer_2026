...
MAX_SPEED = 6.28
Kp = 0.005 # Proportional tuning parameter (Start small!)
base_speed = 0.5 * MAX_SPEED # Forward cruise speed
...
RED_LOWER   = np.array([10, 139, 132])
RED_UPPER   = np.array([179, 255, 185])

GREEN_LOWER = np.array([54, 85, 0])
GREEN_UPPER = np.array([90, 210, 255])

BLUE_LOWER  = np.array([102, 184, 46])
BLUE_UPPER  = np.array([127, 226, 255])
